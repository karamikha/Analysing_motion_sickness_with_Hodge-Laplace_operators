...
def visualize_mne(data, channels_names):
    """Visualize EEG-channels with MNE"""
...
def visualize_matplotlib(data, channels_names, times):
    """Visualize EEG-channels with Matplotlib"""
    channels_q = len(channels_names)
...
def visualize_graph(corr_matrix, channels_names, label):
    """Visualize graph"""
    EEG_graph = nx.Graph()
...
def visualize_func_connectome(corr_matrix, channels_names, label):
